...
namespace ZondyDBHelper
{
    ...
    /// 数据库操作接口
    /// </summary>
    public interface SQLIDbAccess : IDisposable
    {
        /// <summary>
        /// 开启事务
        /// </summary>
        ...
        /// 执行传入SqlCommand对象
        /// </summary>
        /// <param name="strSql">SqlCommand对象</param>
        /// <returns></returns>
        /* 
         * 这个方法引入的类在.net core 中不存在
         * int ExecuteNonQuery(System.Data.SqlClient.SqlCommand SqlCmd);
         */
        /// <summary>
        /// 执行Sql语句
        /// </summary>
        ...
        /// </summary>
        /// <param name="tableName">数据库表名</param>
        /// <param name="ci">表结构</param>
        /// <returns></returns>
        string GetCreateColumnSql(string tableName, ColumnInfo ci);
        /// <summary>
        /// 得到表的创建语句
        /// </summary>
        /// <param name="tableName">数据库表名</param>
        /// <param name="ci">字段结构</param>
        /// <returns></returns>
        string GetCreateTableSql(string tableName, ColumnInfo[] ci);
        /// <summary>
        /// 得到视图的创建语句
        /// </summary>
        /// <param name="viewName">视图名称</param>
        /// <returns></returns>
        string GetCreateViewSql(string viewName);
        /// <summary>
        /// 转换字段类型
        /// </summary>
        /// <param name="ci">字段集合</param>
        /// <param name="dbt">目标数据库类型</param>
        /// <returns></returns>
        ColumnInfo[] ChangeColumnType(ColumnInfo[] ci, DataBaseType dbt);
        /// <summary>
        /// 获取指定数据库表的主键
        /// （如由多个字段联合组成，则以","分隔）
        /// </summary>
        ...
        /// </summary>
        /// <param name="tableName">数据库表名</param>
        /// <returns>返回数据表的物理大小(kb)</returns>
        double GetTablePhySize(string tableName);
        /// <summary>
        /// 快速插入数据
        /// </summary>
